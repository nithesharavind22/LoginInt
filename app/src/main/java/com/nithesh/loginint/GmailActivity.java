...
public class GmailActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(GmailActivity.this);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(GmailActivity.this);
                                ...
                                Auth.GoogleSignInApi.signOut(googleApiClient).setResultCallback(new ResultCallback<Status>() {
                                    ...
                                    public void onResult(@NonNull Status status) {
                                        if (status.isSuccess()) {
                                            ...
                                            Toast.makeText(GmailActivity.this, "Log out success", Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(GmailActivity.this, MainActivity.class);
                                            startActivity(intent);
                                            finish();
                                        } else {
                                            Toast.makeText(GmailActivity.this, "Log out failed", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            }
